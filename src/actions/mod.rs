...
pub mod retrieve_product_by_id {
    include!("../actions/retrieve_product_by_id/action.rs");
}
...
pub mod update_order_by_id {
    include!("../actions/update_order_by_id/action.rs");
}

pub mod update_product_by_id {
    include!("../actions/update_product_by_id/action.rs");
}
